...
const coreGatewayHandlers = {
	...createLazyCoreHandlers({
		methods: [
			...
			"mesnium.agents.get",
			"mesnium.agents.run",
			"mesnium.agents.executeTool",
			"mesnium.agents.pause",
			"mesnium.agents.resume",
			"mesnium.agents.update",
			"mesnium.knowledge.search",
			"mesnium.knowledge.sources",
			"mesnium.automations.list",
			"mesnium.automations.get",
			"mesnium.automations.run",
			"mesnium.automations.runs.list",
			"mesnium.automations.runs.get",
			...
			"mesnium.automations.update",
			"mesnium.automations.delete",
			"mesnium.automations.duplicate",
			"mesnium.knowledge.addSource",
			"mesnium.activity.list",
			"mesnium.connections.status",
			"mesnium.connections.connect",
			"mesnium.connections.disconnect",
			"mesnium.projects.list",
			"mesnium.projects.get",
			"mesnium.projects.create",
			"mesnium.projects.update",
			"mesnium.projects.delete",
			"mesnium.projects.addFile",
			"mesnium.projects.removeFile",
			"mesnium.projects.getContext",
			"mesnium.files.folders.list",
			"mesnium.files.folders.authorize",
			"mesnium.files.folders.revoke",
			"mesnium.files.folders.reauthorize",
			"mesnium.files.list",
			"mesnium.files.search",
			"mesnium.files.read",
			"mesnium.files.inspect",
			"mesnium.files.organize.propose",
			"mesnium.files.organize.execute",
			"mesnium.skills.list",
			"mesnium.skills.vet",
			"mesnium.memory.list",
			"mesnium.memory.add",
			"mesnium.memory.delete",
			"mesnium.memory.clear",
			"mesnium.monitors.list",
			"mesnium.monitors.create",
			"mesnium.monitors.pause",
			"mesnium.monitors.resume",
			"mesnium.monitors.delete",
			"mesnium.monitors.run",
			"mesnium.briefing.get",
			"mesnium.briefing.configure",
			"mesnium.capabilities.status",
			"mesnium.capabilities.list",
			"mesnium.mcp.servers.list",
			"mesnium.mcp.servers.register",
			"mesnium.mcp.servers.delete",
