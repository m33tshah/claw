...
export class MesniumCapabilityRegistry {
  ...
  async getAllCapabilities() {
    ...
    capabilities.push({
      ...
      status: googleStatus?.status || ProviderStatus.REQUIRES_AUTHORIZATION,
      connectedAccount: googleStatus?.email || (googleStatus?.status === ProviderStatus.CONNECTED ? 'Google Account' : 'Not Connected'),
