      ...
      <div class="sidebar-brand">
        <div class="sidebar-brand__identity">
          <img
            ...
            aria-hidden="true"
          />
          ${this.collapsed?l:c`<span class="sidebar-brand__title">Mesnium</span>`}
        </div>
      ...
      <div class="dashboard-header">
        <div class="dashboard-header__breadcrumb">
          ${this.overviewHref?c`
              ...
              `:c`<span class="dashboard-header__breadcrumb-link">Mesnium</span>`}
          ${n?c`
      ...
      >
        <div class="topnav-shell">
          ...
          <div class="topnav-shell__content">
            <div class="topbar-brand" aria-label="Mesnium">
              <img
                ...
                aria-hidden="true"
              />
              <span class="topbar-brand__title">Mesnium</span>
            </div>
            <dashboard-header
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${t} alt="Mesnium" />
          <div class="login-gate__title">Mesnium</div>
