        ...
        ${e.realtimeTalkActive||e.realtimeTalkDetail?s`
              ...
              >
                <span class="agent-chat__talk-status-text">
                  ${e.realtimeTalkDetail??(e.realtimeTalkStatus===`thinking`?`Asking Mesnium...`:e.realtimeTalkStatus===`connecting`?`Connecting voice input...`:`Listening...`)}
                </span>
...
...(truncated)...`)))}}function iC(e,t,n){return s`
  ...
  `}function pC(e){let t=(e.realtimeTalkConversation??[]).filter(t=>t.role!==`assistant`||t.isStreaming);return t.length===0?c:s`
    <div
