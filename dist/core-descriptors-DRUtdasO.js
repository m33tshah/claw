...
const CORE_GATEWAY_METHOD_SPECS = [
	...
	{ name: "mesnium.automations.runs.list", scope: "operator.read" },
	{ name: "mesnium.automations.runs.get", scope: "operator.read" },
	...
	{ name: "mesnium.automations.update", scope: "operator.write" },
	{ name: "mesnium.automations.delete", scope: "operator.write" },
	{ name: "mesnium.automations.duplicate", scope: "operator.write" },
	...
	{ name: "mesnium.connections.connect", scope: "operator.write" },
	{ name: "mesnium.connections.disconnect", scope: "operator.write" },
	{ name: "mesnium.projects.list", scope: "operator.read" },
	{ name: "mesnium.projects.get", scope: "operator.read" },
	{ name: "mesnium.projects.create", scope: "operator.write" },
	{ name: "mesnium.projects.update", scope: "operator.write" },
	{ name: "mesnium.projects.delete", scope: "operator.write" },
	{ name: "mesnium.projects.addFile", scope: "operator.write" },
	{ name: "mesnium.projects.removeFile", scope: "operator.write" },
	{ name: "mesnium.projects.getContext", scope: "operator.read" },
	{ name: "mesnium.files.folders.list", scope: "operator.read" },
	{ name: "mesnium.files.folders.authorize", scope: "operator.write" },
	{ name: "mesnium.files.folders.revoke", scope: "operator.write" },
	{ name: "mesnium.files.folders.reauthorize", scope: "operator.write" },
	{ name: "mesnium.files.list", scope: "operator.read" },
	{ name: "mesnium.files.search", scope: "operator.read" },
	{ name: "mesnium.files.read", scope: "operator.read" },
	{ name: "mesnium.files.inspect", scope: "operator.read" },
	{ name: "mesnium.files.organize.propose", scope: "operator.read" },
	{ name: "mesnium.files.organize.execute", scope: "operator.write" },
	{ name: "mesnium.skills.list", scope: "operator.read" },
	{ name: "mesnium.skills.vet", scope: "operator.read" },
	{ name: "mesnium.memory.list", scope: "operator.read" },
	{ name: "mesnium.memory.add", scope: "operator.write" },
	{ name: "mesnium.memory.delete", scope: "operator.write" },
	{ name: "mesnium.memory.clear", scope: "operator.write" },
	{ name: "mesnium.monitors.list", scope: "operator.read" },
	{ name: "mesnium.monitors.create", scope: "operator.write" },
	{ name: "mesnium.monitors.pause", scope: "operator.write" },
	{ name: "mesnium.monitors.resume", scope: "operator.write" },
	{ name: "mesnium.monitors.delete", scope: "operator.write" },
	{ name: "mesnium.monitors.run", scope: "operator.write" },
	{ name: "mesnium.briefing.get", scope: "operator.read" },
	{ name: "mesnium.briefing.configure", scope: "operator.write" },
	{ name: "mesnium.capabilities.status", scope: "operator.read" },
	{ name: "mesnium.capabilities.list", scope: "operator.read" },
	{ name: "mesnium.mcp.servers.list", scope: "operator.read" },
	{ name: "mesnium.mcp.servers.register", scope: "operator.write" },
	{ name: "mesnium.mcp.servers.delete", scope: "operator.write" },
	{ name: "mesnium.mcp.servers.test", scope: "operator.read" },
	{ name: "mesnium.credentials.set", scope: "operator.write" },
	{ name: "mesnium.credentials.remove", scope: "operator.write" },
	{ name: "mesnium.credentials.report", scope: "operator.read" },
	{ name: "mesnium.agents.executeTool", scope: "operator.write" },
	{ name: "mesnium.agents.pause", scope: "operator.write" },
	{ name: "mesnium.agents.resume", scope: "operator.write" },
	{ name: "mesnium.agents.update", scope: "operator.write" },
	{ name: "mesnium.provider.status", scope: "operator.read" },
	{ name: "mesnium.tasks.list", scope: "operator.read" },
	{ name: "mesnium.tasks.get", scope: "operator.read" },
	{ name: "mesnium.tasks.create", scope: "operator.write" },
	{ name: "mesnium.tasks.update", scope: "operator.write" },
	{ name: "mesnium.tasks.delete", scope: "operator.write" },
	{ name: "mesnium.tasks.run", scope: "operator.write" },
	{ name: "mesnium.widget.config.get", scope: "operator.read" },
	{ name: "mesnium.widget.config.set", scope: "operator.write" },
	{ name: "mesnium.business.context.get", scope: "operator.read" },
	{ name: "mesnium.business.context.set", scope: "operator.write" },
	{ name: "mesnium.business.packs.list", scope: "operator.read" },
	{ name: "mesnium.business.packs.activate", scope: "operator.write" },
	{ name: "mesnium.business.packs.deactivate", scope: "operator.write" },
	{ name: "mesnium.business.effective.get", scope: "operator.read" },
	{ name: "mesnium.workflows.list", scope: "operator.read" },
	{ name: "mesnium.workflows.get", scope: "operator.read" },
	{ name: "mesnium.workflows.create", scope: "operator.write" },
	{ name: "mesnium.workflows.update", scope: "operator.write" },
	{ name: "mesnium.workflows.delete", scope: "operator.write" },
	{ name: "mesnium.workflows.activate", scope: "operator.write" },
	{ name: "mesnium.workflows.pause", scope: "operator.write" },
	{ name: "mesnium.workflows.run", scope: "operator.write" },
	{ name: "mesnium.workflows.runs.list", scope: "operator.read" },
	{ name: "mesnium.workflows.runs.get", scope: "operator.read" },
	{ name: "mesnium.workflows.cancel", scope: "operator.write" },
	{ name: "mesnium.workflows.templates.list", scope: "operator.read" },
	{ name: "mesnium.workflows.templates.get", scope: "operator.read" },
	{
		name: "health",
		scope: "operator.read"
	},
